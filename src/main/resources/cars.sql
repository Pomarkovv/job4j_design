...
insert into cars(name, body_id, eng_id, trans_id)
values ('Nissan AD', 1, 1, 1), ('LandCruiser200', 2, 2, 2), ('Lambo', 3, 3, 3);
...
select e.name from car_engines e left join cars c on c.eng_id = e.id where c.id is null;
